...
{	
	protected $id; //@var ID of the process element definition
	...
	public function __toString () {
		return $this->type.": ".$this->name." (".$this->id.") uitgevoerd door ".(empty($this->service)?"geen enkele service":$this->service);
	}
